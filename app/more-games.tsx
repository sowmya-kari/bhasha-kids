...
type GameId="bubble-pop"|"memory"|"sorting"|"vocabulary"|"actions"|"letter-rain"|"first-letter"|"coloring"|"eco-sort";
...
const gameCatalog:GameCatalogEntry[]=[
  ...
  {id:"sorting",title:"Which Group?",description:"Drag each picture into its matching group — fruits, animals, and more.",icon:"🗂️",accent:"gold",category:"Memory & Sorting",Component:PictureSortingGame},
