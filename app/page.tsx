...
const examples: Record<Language, Record<string, Example>> = {
  Telugu: {
    "అ": { word: "అమ్మ", wordRoman: "Amma", meaning: "Mother", icon: "👩🏽", audio: "/assets/audio/telugu-amma.wav" },
    "ఆ": { word: "ఆకులు", wordRoman: "Aakulu", meaning: "Leaves", icon: "🌿", audio: "/assets/audio/telugu-aakulu.wav" },
    "ఇ": { word: "ఇల్లు", wordRoman: "Illu", meaning: "Home", icon: "🏡", audio: "/assets/audio/telugu-illu.wav" },
    "ఈ": { word: "ఈగ", wordRoman: "Eega", meaning: "Fly", icon: "🪰", audio: "/assets/audio/telugu-eega.wav" },
    "ఉ": { word: "ఉడుత", wordRoman: "Udutha", meaning: "Squirrel", icon: "🐿️", audio: "/assets/audio/telugu-udutha.wav" },
    "ఊ": { word: "ఊయల", wordRoman: "Ooyala", meaning: "Swing", icon: "swing", audio: "/assets/audio/telugu-ooyala.wav" },
    "ఋ": { word: "ఋషి", wordRoman: "Rushi", meaning: "Sage", icon: "🧘🏽", audio: "/assets/audio/telugu-rushi.wav" },
    "ౠ": { word: "రూక", wordRoman: "Rooka", meaning: "Coin / money", icon: "🪙", audio: "/assets/audio/telugu-rooka.wav" },
    "ఎ": { word: "ఎలుక", wordRoman: "Eluka", meaning: "Mouse", icon: "🐭", audio: "/assets/audio/telugu-eluka.wav" },
    "ఏ": { word: "ఏనుగు", wordRoman: "Aenugu", meaning: "Elephant", icon: "🐘", audio: "/assets/audio/telugu-aenugu.wav" },
    "ఐ": { word: "ఐదు", wordRoman: "Aidu", meaning: "Five", icon: "5️⃣", audio: "/assets/audio/telugu-aidu.wav" },
    "ఒ": { word: "ఒంటె", wordRoman: "Onte", meaning: "Camel", icon: "🐪", audio: "/assets/audio/telugu-onte.wav" },
    "ఓ": { word: "ఓడ", wordRoman: "Oada", meaning: "Boat", icon: "⛵", audio: "/assets/audio/telugu-oada.wav" },
    "ఔ": { word: "ఔషధం", wordRoman: "Aushadham", meaning: "Medicine", icon: "💊", audio: "/assets/audio/telugu-aushadham.wav" },
    "అం": { word: "అంకె", wordRoman: "Anke", meaning: "Number", icon: "🔢", audio: "/assets/audio/telugu-anke.wav" },
    "అః": { word: "అంతఃపురం", wordRoman: "Anthaapuram", meaning: "Inner palace", icon: "🏰", audio: "/assets/audio/telugu-anthaapuram.wav" },
    "క": { word: "కమలం", wordRoman: "Kamalam", meaning: "Lotus", icon: "🪷", audio: "/assets/audio/telugu-kamalam.wav" },
    "ఖ": { word: "ఖడ్గం", wordRoman: "Khadgam", meaning: "Sword", icon: "⚔️", audio: "/assets/audio/telugu-khadgam.wav" },
    "గ": { word: "గడియారం", wordRoman: "Gadiyaaram", meaning: "Clock", icon: "⏰", audio: "/assets/audio/telugu-gadiyaaram.wav" },
    "ఘ": { word: "ఘటం", wordRoman: "Ghatam", meaning: "Pot", icon: "🏺", audio: "/assets/audio/telugu-ghatam.wav" },
    "ఙ": { word: "విఙ్ఞానం", wordRoman: "Vignaanam", meaning: "Knowledge", icon: "🧠", audio: "/assets/audio/telugu-vignaanam.wav" },
    "చ": { word: "చందమామ", wordRoman: "Chandamama", meaning: "Moon", icon: "🌙", audio: "/assets/audio/telugu-chandamama.wav" },
    "ఛ": { word: "ఛత్రం", wordRoman: "Chhatram", meaning: "Umbrella", icon: "☂️", audio: "/assets/audio/telugu-chhatram.wav" },
    "జ": { word: "జింక", wordRoman: "Jinka", meaning: "Deer", icon: "🦌", audio: "/assets/audio/telugu-jinka.wav" },
    "ఝ": { word: "ఝరి", wordRoman: "Jhari", meaning: "Waterfall", icon: "🌊", audio: "/assets/audio/telugu-jhari.wav" },
    "ఞ": { word: "ఞకారం", wordRoman: "Nyakaaram", meaning: "Nya sound", icon: "🔤" },
    "ట": { word: "టమాటా", wordRoman: "Tamaata", meaning: "Tomato", icon: "🍅", audio: "/assets/audio/telugu-tamaata.wav" },
    "ఠ": { word: "ఠకారం", wordRoman: "Thakaaram", meaning: "Tha sound", icon: "🔤" },
    "డ": { word: "డబ్బా", wordRoman: "Dabbaa", meaning: "Box", icon: "📦", audio: "/assets/audio/telugu-dabbaa.wav" },
    "ఢ": { word: "ఢంకా", wordRoman: "Dhankaa", meaning: "Drum", icon: "🥁", audio: "/assets/audio/telugu-dhankaa.wav" },
    "ణ": { word: "వీణ", wordRoman: "Veena", meaning: "Musical instrument", icon: "/assets/images/veena.png", audio: "/assets/audio/telugu-veena.wav" },
    "త": { word: "తల", wordRoman: "Tala", meaning: "Head", icon: "👤", audio: "/assets/audio/telugu-tala.wav" },
    "థ": { word: "థర్మామీటర్", wordRoman: "Thermometer", meaning: "Thermometer", icon: "🌡️", audio: "/assets/audio/telugu-thermometer.wav" },
    "ద": { word: "దానిమ్మ", wordRoman: "Daanimma", meaning: "Pomegranate", icon: "/assets/images/pomegranate.png", audio: "/assets/audio/telugu-daanimma.wav" },
    "ధ": { word: "ధనుస్సు", wordRoman: "Dhanussu", meaning: "Bow", icon: "🏹", audio: "/assets/audio/telugu-dhanussu.wav" },
    "న": { word: "నక్క", wordRoman: "Nakka", meaning: "Fox", icon: "🦊", audio: "/assets/audio/telugu-nakka.wav" },
    "ప": { word: "పాప", wordRoman: "Paapa", meaning: "Child", icon: "👧", audio: "/assets/audio/telugu-paapa.wav" },
    "ఫ": { word: "ఫలం", wordRoman: "Phalam", meaning: "Fruit", icon: "🍇", audio: "/assets/audio/telugu-phalam.wav" },
    "బ": { word: "బంతి", wordRoman: "Banthi", meaning: "Ball", icon: "⚽", audio: "/assets/audio/telugu-banthi.wav" },
    "భ": { word: "భవనం", wordRoman: "Bhavanam", meaning: "Building", icon: "🏢", audio: "/assets/audio/telugu-bhavanam.wav" },
    "మ": { word: "మామిడి", wordRoman: "Maamidi", meaning: "Mango", icon: "🥭", audio: "/assets/audio/telugu-maamidi.wav" },
    "య": { word: "యంత్రం", wordRoman: "Yanthram", meaning: "Machine", icon: "⚙️", audio: "/assets/audio/telugu-yanthram.wav" },
    "ర": { word: "రథం", wordRoman: "Ratham", meaning: "Chariot", icon: "🛞", audio: "/assets/audio/telugu-ratham.wav" },
    "ల": { word: "లడ్డు", wordRoman: "Laddu", meaning: "Sweet", icon: "🍬", audio: "/assets/audio/telugu-laddu.wav" },
    "వ": { word: "వంకాయ", wordRoman: "Vankaaya", meaning: "Eggplant", icon: "🍆", audio: "/assets/audio/telugu-vankaaya.wav" },
    "శ": { word: "శంఖం", wordRoman: "Shankham", meaning: "Conch", icon: "🐚", audio: "/assets/audio/telugu-shankham.wav" },
    "ష": { word: "షడ్రుచులు", wordRoman: "Shadruchulu", meaning: "Six tastes", icon: "6️⃣", audio: "/assets/audio/telugu-shadruchulu.wav" },
    "స": { word: "సీతాకోకచిలుక", wordRoman: "Seethakokachiluka", meaning: "Butterfly", icon: "🦋", audio: "/assets/audio/telugu-seethakokachiluka.wav" },
    "హ": { word: "హంస", wordRoman: "Hamsa", meaning: "Swan", icon: "🦢", audio: "/assets/audio/telugu-hamsa.wav" },
    "ళ": { word: "కళ", wordRoman: "Kala", meaning: "Art", icon: "🎨", audio: "/assets/audio/telugu-kala.wav" },
    "క్ష": { word: "క్షమ", wordRoman: "Kshama", meaning: "Forgiveness", icon: "🤝", audio: "/assets/audio/telugu-kshama.wav" },
    "ఱ": { word: "గుఱ్ఱము", wordRoman: "Gurramu", meaning: "Horse", icon: "🐎", audio: "/assets/audio/telugu-gurramu.wav" },
  },
  Hindi: {
    "अ": { word: "अनार", wordRoman: "Anaar", meaning: "Pomegranate", icon: "/assets/images/pomegranate.png", audio: "/assets/audio/hindi-anaar.wav" },
    "आ": { word: "आम", wordRoman: "Aam", meaning: "Mango", icon: "🥭", audio: "/assets/audio/hindi-aam.wav" },
    "इ": { word: "इमली", wordRoman: "Imli", meaning: "Tamarind", icon: "🌿", audio: "/assets/audio/hindi-imli.wav" },
    "ई": { word: "ईख", wordRoman: "Eekh", meaning: "Sugarcane", icon: "🎋", audio: "/assets/audio/hindi-eekh.wav" },
    "उ": { word: "उल्लू", wordRoman: "Ullu", meaning: "Owl", icon: "🦉", audio: "/assets/audio/hindi-ullu.wav" },
    "ऊ": { word: "ऊन", wordRoman: "Oon", meaning: "Wool", icon: "🧶", audio: "/assets/audio/hindi-oon.wav" },
    "ऋ": { word: "ऋषि", wordRoman: "Rishi", meaning: "Sage", icon: "🧘🏽", audio: "/assets/audio/hindi-rishi.wav" },
    "ए": { word: "एक", wordRoman: "Ek", meaning: "One", icon: "1️⃣", audio: "/assets/audio/hindi-ek.wav" },
    "ऐ": { word: "ऐनक", wordRoman: "Ainak", meaning: "Glasses", icon: "👓", audio: "/assets/audio/hindi-ainak.wav" },
    "ओ": { word: "ओखली", wordRoman: "Okhli", meaning: "Mortar", icon: "🥣", audio: "/assets/audio/hindi-okhli.wav" },
    "औ": { word: "औरत", wordRoman: "Aurat", meaning: "Woman", icon: "👩🏽", audio: "/assets/audio/hindi-aurat.wav" },
    "अं": { word: "अंगूर", wordRoman: "Angoor", meaning: "Grapes", icon: "🍇", audio: "/assets/audio/hindi-angoor.wav" },
    "अः": { word: "नामः", wordRoman: "Naamaha", meaning: "Name", icon: "🏷️", audio: "/assets/audio/hindi-naamah.wav" },
    "क": { word: "कबूतर", wordRoman: "Kabootar", meaning: "Pigeon", icon: "🕊️", audio: "/assets/audio/hindi-kabootar.wav" },
    "ख": { word: "खरगोश", wordRoman: "Khargosh", meaning: "Rabbit", icon: "🐇", audio: "/assets/audio/hindi-khargosh.wav" },
    "ग": { word: "गमला", wordRoman: "Gamla", meaning: "Flowerpot", icon: "🪴", audio: "/assets/audio/hindi-gamla.wav" },
    "घ": { word: "घर", wordRoman: "Ghar", meaning: "Home", icon: "🏠", audio: "/assets/audio/hindi-ghar.wav" },
    "ङ": { word: "ङकार", wordRoman: "Ngakaar", meaning: "Nga sound", icon: "🔤" },
    "च": { word: "चम्मच", wordRoman: "Chammach", meaning: "Spoon", icon: "🥄", audio: "/assets/audio/hindi-chammach.wav" },
    "छ": { word: "छतरी", wordRoman: "Chhatri", meaning: "Umbrella", icon: "☂️", audio: "/assets/audio/hindi-chhatri.wav" },
    "ज": { word: "जहाज", wordRoman: "Jahaaz", meaning: "Ship", icon: "🚢", audio: "/assets/audio/hindi-jahaaz.wav" },
    "झ": { word: "झंडा", wordRoman: "Jhanda", meaning: "Flag", icon: "🚩", audio: "/assets/audio/hindi-jhanda.wav" },
    "ञ": { word: "ञकार", wordRoman: "Nyakaar", meaning: "Nya sound", icon: "🔤" },
    "ट": { word: "टमाटर", wordRoman: "Tamaatar", meaning: "Tomato", icon: "🍅", audio: "/assets/audio/hindi-tamaatar.wav" },
    "ठ": { word: "ठेला", wordRoman: "Thela", meaning: "Cart", icon: "🛒", audio: "/assets/audio/hindi-thela.wav" },
    "ड": { word: "डमरू", wordRoman: "Damru", meaning: "Drum", icon: "🥁", audio: "/assets/audio/hindi-damru.wav" },
    "ढ": { word: "ढक्कन", wordRoman: "Dhakkan", meaning: "Lid", icon: "🫙", audio: "/assets/audio/hindi-dhakkan.wav" },
    "ण": { word: "णकार", wordRoman: "Nakaar", meaning: "Na sound", icon: "🔤" },
    "त": { word: "तरबूज", wordRoman: "Tarbooz", meaning: "Watermelon", icon: "🍉", audio: "/assets/audio/hindi-tarbooz.wav" },
    "थ": { word: "थर्मस", wordRoman: "Thermos", meaning: "Flask", icon: "🧴", audio: "/assets/audio/hindi-thermos.wav" },
    "द": { word: "दरवाज़ा", wordRoman: "Darwaaza", meaning: "Door", icon: "🚪", audio: "/assets/audio/hindi-darwaaza.wav" },
    "ध": { word: "धनुष", wordRoman: "Dhanush", meaning: "Bow", icon: "🏹", audio: "/assets/audio/hindi-dhanush.wav" },
    "न": { word: "नल", wordRoman: "Nal", meaning: "Tap", icon: "🚰", audio: "/assets/audio/hindi-nal.wav" },
    "प": { word: "पतंग", wordRoman: "Patang", meaning: "Kite", icon: "🪁", audio: "/assets/audio/hindi-patang.wav" },
    "फ": { word: "फल", wordRoman: "Phal", meaning: "Fruit", icon: "🍎", audio: "/assets/audio/hindi-phal.wav" },
    "ब": { word: "बकरी", wordRoman: "Bakri", meaning: "Goat", icon: "🐐", audio: "/assets/audio/hindi-bakri.wav" },
    "भ": { word: "भालू", wordRoman: "Bhaalu", meaning: "Bear", icon: "🐻", audio: "/assets/audio/hindi-bhaalu.wav" },
    "म": { word: "मछली", wordRoman: "Machhli", meaning: "Fish", icon: "🐟", audio: "/assets/audio/hindi-machhli.wav" },
    ...
    "व": { word: "वन", wordRoman: "Van", meaning: "Forest", icon: "🌳", audio: "/assets/audio/hindi-van.wav" },
    "श": { word: "शेर", wordRoman: "Sher", meaning: "Lion", icon: "🦁", audio: "/assets/audio/hindi-sher.wav" },
    "ष": { word: "षट्कोण", wordRoman: "Shatkon", meaning: "Hexagon", icon: "🔷", audio: "/assets/audio/hindi-shatkon.wav" },
    "स": { word: "सूरज", wordRoman: "Sooraj", meaning: "Sun", icon: "☀️", audio: "/assets/audio/hindi-sooraj.wav" },
    "ह": { word: "हाथी", wordRoman: "Haathi", meaning: "Elephant", icon: "🐘", audio: "/assets/audio/hindi-haathi.wav" },
    "क्ष": { word: "क्षमा", wordRoman: "Kshama", meaning: "Forgiveness", icon: "🤝", audio: "/assets/audio/hindi-kshama.wav" },
    "त्र": { word: "त्रिशूल", wordRoman: "Trishul", meaning: "Trident", icon: "🔱", audio: "/assets/audio/hindi-trishul.wav" },
    "ज्ञ": { word: "ज्ञान", wordRoman: "Gyaan", meaning: "Knowledge", icon: "📚", audio: "/assets/audio/hindi-gyaan.wav" },
  },
};
